...
export default function Footer() {
  ...
  return (
    <footer ref={containerRef} className="bg-charcoal text-warm-white">
      {/* Marquee Banner */}
      <div className="border-b border-warm-white/10 py-6 overflow-hidden">
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-20 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 flex items-center justify-center border border-warm-white/20 text-warm-white/60 hover:bg-gold hover:border-gold hover:text-charcoal transition-all duration-300"
          ...
          >
            <h4 className="text-sm tracking-[0.2em] uppercase mb-6">Explore</h4>
            <ul className="space-y-3">
              {footerLinks.explore.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-warm-white/60 hover:text-gold font-light transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          >
            <h4 className="text-sm tracking-[0.2em] uppercase mb-6">Company</h4>
            <ul className="space-y-3">
          ...
          >
            <h4 className="text-sm tracking-[0.2em] uppercase mb-6">Support</h4>
            <ul className="space-y-3">
